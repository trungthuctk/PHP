...
<?php 	
    ...
    foreach ($data as $value) {
		$html_products .= '<div class="col-sm-4">
			...
			<div class="single-products">
				...
				<div class="product-overlay">
					<div class="overlay-content">
						<h2>'.$value['price'].'</h2>
						<p>'.$value['name'].'</p>
						<a id="'.$value['id'].'"class="btn btn-default add-to-cart" name="submit"><i class="fa fa-shopping-cart"></i>Add to cart</a>
					</div>
				</div>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<form action="" method="POST">
													...
													<input type="hidden" name="name" value ="Easy Polo Black Edition">
													<button  class="btn btn-default add-to-cart" name="submit"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</form>	
											</div>
										</div>
								</div>
