...
<?php 	
		...
		if ($result->num_rows > 0) {
		 // echo 123;
			...
			while($row = $result->fetch_assoc()) {
				...
				//var_dump($row);
				global $_name,$_email,$_password,$_img;
				$_name = $row["name"];
				$_email = $row["email"];
   ...
   // echo $id;
        ...
        $arrImg=array('png','jpg','PNG','JPG','GIP','gip');
        $check_img = explode('.',$str);
		//var_dump($str);
        $_img=$str;
          ...
          else if($_FILES['avatar']['size']>(1024*1014)){
                  $error_img = 'Khong duoc upload file lon hon 1Mb';
                  $check = false; 
              }
          else if(!in_array($check_img[1],$arrImg)){
                $error_img = 'Vui long upload file hinh anh';
                $check = false; 
              }
        }   
					...
					<div class="features_items"><!--features_items-->
                        ...
                        <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" enctype="multipart/form-data">
                            <div class="form-group col-md-6">
				                <input type="text" name="email" class="form-control"  placeholder="Email"  value=<?php echo $_email;?>>
								<small id="emailHelp" class="form-text text-muted"><?php echo $error_email; ?></small>
				            </div>
				            <div class="form-group col-md-6">
				                <input type="password" name="password" class="form-control"  placeholder="Password" >
								<!-- <small id="emailHelp" class="form-text text-muted"><?php echo $error_password; ?></small> -->
							</div>
				           
				            <div class="form-group col-md-12">
				                <input type="text" name="name" class="form-control"  placeholder="Name" value=<?php echo $_name;?>>
								<small id="emailHelp" class="form-text text-muted"><?php echo $error_name; ?></small>
							</div>
				            <div class="form-group col-md-12">
                            <input type="file" name="avatar"/>
				            <div class="form-group col-md-12">
				                <input type="submit" name="submit" class="btn btn-primary pull-right" value="Submit">
								<small id="emailHelp" class="form-text text-muted"><?php echo $error_img; ?></small>
				            </div>
							<small id="emailHelp" class="form-text text-muted"><?php echo $p ?></small>
